...
; set_to true (equal)
(define-fun |main::1::dividend!0@1#2| () (_ BitVec 32) (_ bv0 32))
...
; set_to true (equal)
(define-fun |main::1::divisor!0@1#2| () (_ BitVec 32) (_ bv0 32))
...
; set_to true (equal)
(define-fun |divide(unsigned_int,unsigned_int,ptr_unsigned_int,ptr_unsigned_int)::dividend!0@1#1| () (_ BitVec 32) (_ bv0 32))

; set_to true (equal)
(define-fun |divide(unsigned_int,unsigned_int,ptr_unsigned_int,ptr_unsigned_int)::divisor!0@1#1| () (_ BitVec 32) (_ bv0 32))
...
; set_to true (equal)
(define-fun |printf::va_arg!0#1| () (_ BitVec 32) (_ bv0 32))
...
; set_to true (equal)
(define-fun |printf::va_arg$0!0#1| () (_ BitVec 32) (_ bv0 32))
