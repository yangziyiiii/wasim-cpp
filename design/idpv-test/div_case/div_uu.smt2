...
; set_to true (equal)
(define-fun |divide(unsigned_short_int,unsigned_char,ptr_unsigned_char,ptr_unsigned_char)::dividend!0@1#1| () (_ BitVec 16) (_ bv0 16))

; set_to true (equal)
(define-fun |divide(unsigned_short_int,unsigned_char,ptr_unsigned_char,ptr_unsigned_char)::divisor!0@1#1| () (_ BitVec 8) (_ bv0 8))
...
; set_to true (equal)
(define-fun |printf::va_arg!0#1| () (_ BitVec 8) (_ bv0 8))
...
; set_to true (equal)
(define-fun |printf::va_arg$0!0#1| () (_ BitVec 8) (_ bv0 8))
