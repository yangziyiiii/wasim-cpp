...
int main()
{
  ...
  // smt::SubstitutionWalker substitution_walker(solver,
  // substitution_map); cout << "after merge, map size: " <<
  // substitution_map.size() << endl; Term merged_ast =
  // substitution_walker.visit(res_ast);
  return 0;
}