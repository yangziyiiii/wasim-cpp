...
void init_array(TransitionSystem &sts1,
...
int main() {
    ...
    BTOR2Encoder btor_parser1("../design/smt-sweeping/case3/aes-verilog/Encrypt.btor2", sts1, "a::");
    ...
    // ARRAY INIT
    init_array(sts1, sts2, all_luts, substitution_map);
    ...
    post_order_traversal(root, sts1, sts2, num_iterations, node_data_map, all_luts, substitution_map, hash_term_map, solver, count, unsat_count, sat_count);
    std::cout << std::endl;
